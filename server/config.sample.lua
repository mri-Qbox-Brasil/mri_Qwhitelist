    ...
    Questions = {
        {
            ...
            options = {
                ...
                {label = 'Metagaming é quando você tenta vender pés de galinha para as pessoas e você não tem nenhum pé de galinha.', value = false},
        ...
        },
        {
            ...
            options = {
                ...
                {label = 'Powergaming é o uso do cartão de crédito da sua mãe para comprar Fundador Suporte ;)', value = false},
